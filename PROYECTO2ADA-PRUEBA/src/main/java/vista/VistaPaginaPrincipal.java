...
public class VistaPaginaPrincipal extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(VistaPaginaPrincipal.class.getName());

 
    public VistaPaginaPrincipal() {
        initComponents();
        setTitle("DBrújula - Panel Principal");
    ...
    private void initComponents() {
        ...
        ListaRutas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Distancia", "Dificultad", "Ubicación", "Autor"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new VistaPaginaPrincipal().setVisible(true));
    }
